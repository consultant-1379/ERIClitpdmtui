define(function() {
    var d3 = function() {
        ...
        /**
         * OVERIDDEN Firefox and Chrome default mousescroll values.
         * Line 1273: (d3.event.deltaMode ? 120 : 1) -->  (d3.event.deltaMode ? 120/6 : 1)
         * Line 1275: d3.event.wheelDelta -->  d3.event.wheelDelta/2
         */
        var d3_behavior_zoomDelta, d3_behavior_zoomWheel = "onwheel" in d3_document ? (d3_behavior_zoomDelta = function() {
            return -d3.event.deltaY * (d3.event.deltaMode ? 120/6 : 1);
        }, "wheel") : "onmousewheel" in d3_document ? (d3_behavior_zoomDelta = function() {
            return d3.event.wheelDelta/2;
